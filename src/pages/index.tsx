    ...
    <S.ScrollContainer ref={scrollRef}>
      <Layout>
        <S.MainFirstContainer>
          <S.SVGContainer>
            <S.SVGGuitarContainer style={{ width: '700px' }}>
              <svg
            ...
            </S.SVGGuitarContainer>
            <S.SVGDrumContainer style={{ width: '700px' }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 465.072 465.072"
              >
